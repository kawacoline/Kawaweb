...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const workData = [
        ...
        { type: 'devProjects', title: 'PROJECTS', items: [{ title: 'Rhythm Game', image: 'https://pbs.twimg.com/media/GqHVqlzagAAIAuI?format=png&name=small', description: "I was bored <a href='#' target='_blank'>Play now!</a> фффффффф", downloadLink: '#', }, { title: 'This Website!', image: 'https://res.cloudinary.com/dru0licqm/image/upload/v1748710517/chrome_LsMZLfLxop_k9pz2c.png', description: "The very portfolio you are looking at now. Built with HTML, CSS, and vanilla JavaScript. Features include draggable and resizable modal windows, and an audio visualizer.", }] },
